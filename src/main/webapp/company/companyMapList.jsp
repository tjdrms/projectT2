...
<br>   
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=61c77bfef760de50784298ccbab79587"></script>
   <script>
   ...
   for (i=0 ; i <= title.length ; i++ ){
      positions[i] = {
            content : ' <div style="padding:5px;"> '+ title[i] +' <br> ' 
                  + '  '  + rdnmadr[i] + '<br>'
                  + ' <a href=companyMapEdit.do?idx=' + idx[i] + ' style="color:blue">상세정보</a></div>',
